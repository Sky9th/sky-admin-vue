                            ...
                            <el-form :model="formLogin" :rules="rules" label-position="top" ref="loginForm" @submit="submit"
                                ...
                                <el-form-item prop="username">
                                    <el-input placeholder="用户名" type="text" v-model="formLogin.username" @blur="refreshVerify"><i
                                            class="fa fa-user-circle-o" slot="prepend"></i></el-input>
                                </el-form-item>
                                <el-form-item prop="password">
                                    <el-input placeholder="密码" type="password" v-model="formLogin.password"><i
                                            class="fa fa-keyboard-o" slot="prepend"></i></el-input>
                                </el-form-item>
                                <el-form-item prop="code">
                                    <el-input placeholder="验证码" type="text" v-model="formLogin.code">
                                        <template slot="append"><img class="login-code" :src="verifyImg" @click="refreshVerify"></template>
                                    </el-input>
                                </el-form-item>
                                <el-button @click="submit" class="button-login" size="default" type="primary">登录
                                </el-button>
                            </el-form>
                        </el-card>
                    </div>
...
import { LoginVerify } from '@/api/sys/login'
