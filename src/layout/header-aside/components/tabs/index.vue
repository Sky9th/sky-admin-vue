      ...
      <el-dropdown
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item command="left">
            <d2-icon class="d2-mr-10" name="arrow-left"/>
            关闭左侧
          </el-dropdown-item>
          <el-dropdown-item command="right">
            <d2-icon class="d2-mr-10" name="arrow-right"/>
            关闭右侧
          </el-dropdown-item>
          <el-dropdown-item command="other">
            <d2-icon class="d2-mr-10" name="times"/>
            关闭其它
          </el-dropdown-item>
          <el-dropdown-item command="all">
            <d2-icon class="d2-mr-10" name="times-circle"/>
            全部关闭
          </el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
